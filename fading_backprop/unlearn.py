...
# %% load dataset
# only use one ~600MB shard; also, streaming would make splitting too slow
oscar_tmpl = "hf://datasets/oscar-corpus/OSCAR-2301/{lang}_meta/{lang}_meta_part_1.jsonl.zst"  # fmt: skip
raw_dataset = load_dataset("text", data_files=oscar_tmpl.format(lang="pl"))
raw_dataset = raw_dataset["train"]  # train is the only split
