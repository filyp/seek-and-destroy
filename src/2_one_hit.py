...
# %%
unlearn_and_relearn(retain_lr=0, circuit_name="forget_linear_correct_logit")
# %%
unlearn_and_relearn(retain_lr=0, circuit_name="forget_linear_cross_entropy")
