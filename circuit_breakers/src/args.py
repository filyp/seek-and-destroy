...
class LorraArguments:
    target_layers: str = field(metadata={
                               "help": "Layers for Representation. Layers are seperate by `,` eg: `10,12,14,16,18,20` "})
    transform_layers: str = field(metadata={
                                  "help": "Layers for Representation. Layers are seperate by `,` eg: `10,12,14,16,18,20` "})
    lorra_alpha: float = field(
        default=5, metadata={"help": ""})  # LoRRA Hyperparameters
    trainsets: typing.List[str] = field(default=None, metadata={
    ...
    valsets: typing.List[str] = field(default=None, metadata={
    ...
    adv_string: str = field(default="", metadata={
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    dataloader_pin_memory: bool = field(default=False, metadata={
                                        'help': 'Makes loading something faster - Filip\'s data loader already loads data on GPU so we are not using it'})
